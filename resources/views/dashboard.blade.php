...
>
  <head>
    ...
    />
    <style>
      /* Mendefinisikan font lokal menggunakan @font-face */
      @font-face {
        font-family: 'jawa';
        src: url('../assets/Jawa\ Palsu\ 400.ttf') format('truetype');
      }
      @font-face {
        font-family: 'poppins';
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-lg-8 mb-15 order-0">
                  <div class="card">
                      <div class="d-flex align-items-end row">
                          <div class="col-sm-15">
                              <div class="card-body">
                                  <h5  style="font-family: 'poppins', sans-serif; font-weight: bold; font-size: 20px; color: black;">Detail Aplikasi Notifikasi Kepegawaian 📈</h5>
                                  <ul>
                                      <li><span class="fw-bold" style="font-family: 'poppins', sans-serif; font-size: 14px; color: gray;">pendataan pegawai sesuai dengan kebutuhan administrasi Kepegawaian dengan mengacu pada Jadwal Kenaikan Gaji Berkala, Kenaikan pangkat, dan Pensiun masing masing karyawan</li>
                                  </ul>
                          ...
                          <div class="col-sm-5 text-center text-sm-left">
                              <div class="card-body pb-0 px-0 px-md-4">
                                  <!-- Anda bisa menambahkan gambar atau elemen lain di sini jika diperlukan -->
                              </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card custom-card">
                                ...
                                <h3 class="card-title text-nowrap mb-3">{{ $totalGmail }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-md-6 col-lg-4 order-2 mb-4">
  <div class="card h-80">
    <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="card-title m-0 me-2">Daftar Fitur Aplikasi</h5>
      <div class="dropdown">
        <button
          class="btn p-0"
          type="button"
      ...
      <ul class="p-0 m-0">
        <li class="d-flex mb-4 pb-1">
          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
              <small class="text-muted d-block mb-1">Add</small>
              <h6 class="mb-0">Tambah Data Karyawan</h6>
            </div>
          </div>
        </li>
        <li class="d-flex mb-4 pb-1">
          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
              <small class="text-muted d-block mb-1">Edit</small>
              <h6 class="mb-0">Edit Status dan Data Pegawai</h6>
            </div>
          </div>
        </li>
        <li class="d-flex mb-4 pb-1">
          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
              <small class="text-muted d-block mb-1">Delete</small>
              <h6 class="mb-0">Hapus Data Yang Diinginkan</h6>
            </div>
          </div>
        </li>
        <li class="d-flex mb-4 pb-1">
          ...
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
              <small class="text-muted d-block mb-1">Read</small>
              <h6 class="mb-0">Cek Data Pegawai Keseluruhan</h6>
            </div>
          </div>
        </li>
      </ul>
...
<!--/ Transactions -->
 ...
 <div class="col-md-6 col-lg-4 order-2 mb-4">
  <div class="card h-80">
    <div class="card-header d-flex align-items-center justify-content-between">
      <h5 class="card-title m-0 me-2">Daftar Pegawai Penerima Notifikasi</h5>
      <div class="dropdown">
        <button
          class="btn p-0"
          type="button"
    ...
    <div class="card-body">
      <ul class="p-0 m-0">
        <li class="d-flex mb-4 pb-1">
          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
            <div class="me-2">
              <small class="text-muted d-block mb-1">KaSub. Bag Kepegawaian</small>
              <h6 class="mb-0">Dion Hena</h6>
            </div>
            <div class="user-progress d-flex align-items-center gap-1">
              <h6 class="mb-0">Kenaikan Gaji Berkala</h6>
            </div>
          </div>
        </li>
        <li class="d-flex mb-4 pb-1">
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card custom-card">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="{{ asset('sneat/assets/img/icons/unicons/bell-ring-solid-24.png') }}" alt="Incomplete Data" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                                type="button"
                                id="cardOptIncomplete"
                                data-bs-toggle="dropdown"
                                aria-haspopup="true"
                                aria-expanded="false"
                              >
                          ...
                          <span class="fw-semibold d-block mb-1">Data Tidak Lengkap</span>
                          <h3 class="card-title text-nowrap mb-3">{{ $incompleteDataCount }}</h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card custom-card">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="{{ asset('sneat/assets/img/icons/unicons/user-check-solid-24.png') }}" alt="Contract Ending Soon" class="rounded" />
                            </div>
                            <div class="dropdown">
                              <button
                                class="btn p-0"
                          ...
                          <span class="fw-semibold d-block mb-1">Kontrak Hampir Habis</span>
                          <h3 class="card-title text-nowrap mb-3">{{ $contractEndingSoonCount }}</h3>
                        </div>
                      </div>
                    </div>
                </div>
